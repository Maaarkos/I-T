...
### 🧠 Deep Dive: The IKEv2 Architecture (Before we configure)

Before we jump into the CLI, we must understand how IKEv2 changed the rules of the game.
...
#### 🧩 Wait, why do we have TWO profiles attached to each other?
Look at Step 6. We put the `ikev2-profile` INSIDE the `ipsec profile`. Why?
...
#### 🌍 Where is the IKEv2 Policy attached?
...
#### 🛣️ Routing Note: `no auto-summary`
